...
const FormsAgainstCOScreen = () => {
    ...
    const handleFetchExistingGRTForms = async () => {
        ...
        const creds = {
            ...
            "created_by": params?.emp_code
        }

        // console.log(">>>>>>>>>>>>>>", creds)

        await axios.post(`${ADDRESSES.GET_FORM_AGAINST_CO}`, creds, {
            headers: {
                            ...
                            <List.Item
                                ...
                                description={
                                    <View>
                                        ...
                                        <Text>{item?.client_name || "Nil"} - {item?.member_code || "Nil"}</Text>
                                        {/* <Text style={{
...
export default FormsAgainstCOScreen
