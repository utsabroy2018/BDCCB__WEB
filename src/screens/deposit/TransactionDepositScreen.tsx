...
const TransactionDepositScreen = () => {
  ...
  const fetchEmployeeAttendanceDetails = async (slNo: string) => {
    ...
    await axios.post(`${ADDRESSES.FETCH_EMP_ATTENDANCE_DETAILS}`, creds, {
            headers: {
                Authorization: loginStore?.token, // example header
                "Content-Type": "application/json", // optional
            }
  ...
  return (
    <SafeAreaView>
      <ScrollView
        ...
        <HeadingComp
          title="Transaction Of Deposit"
          subtitle="View your transaction"
          isBackEnabled
        />
        <View
          style={{
...
export default TransactionDepositScreen;
