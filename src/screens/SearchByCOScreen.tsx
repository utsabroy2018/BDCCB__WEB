...
const { handleLogout } = useContext<any>(AppStore)
    ...
    const handleSearch = async () => {
        ...
        await axios.post(`${ADDRESSES.SEARCH_CO}`, creds, {
            headers: {
    ...
    return (
        <SafeAreaView>
            <ScrollView style={{
                ...
                <HeadingComp title="Existing COs" subtitle="Find Credit Officers by" isBackEnabled />
                <View style={{
                            ...
                            <List.Item
                                ...
                                description={
                                    <View>
                                        ...
                                        <Text>Employee ID - {item?.emp_id || "Nil"}</Text>
                                        {/* <Text style={{
...
export default SearchByCOScreen
