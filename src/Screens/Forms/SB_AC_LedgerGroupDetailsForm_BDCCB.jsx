...
import { SB_AC_Group_DetailsHeader, txnDetailsHeader } from "../../Utils/Reports/headerMap"
...
function SB_AC_LedgerGroupDetailsForm_BDCCB() {
	...
	const headersToExport = SB_AC_Group_DetailsHeader

	const fileName = `SB_A/C_Group_Details_${new Date().toLocaleString("en-GB")}.xlsx`
...
export default SB_AC_LedgerGroupDetailsForm_BDCCB
