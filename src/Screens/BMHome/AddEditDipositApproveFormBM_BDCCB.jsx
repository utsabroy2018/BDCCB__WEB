...
import DepositForm_BDCCB from "../Forms/DepositForm_BDCCB"
import DepositFormApprove_BDCCB from "../Forms/DepositFormApprove_BDCCB"

function AddEditDipositApproveFormBM_BDCCB() {
				...
				<div className="p-5 w-4/5 min-h-screen rounded-3xl">
					...
					>
						<div className="card shadow-lg bg-white border-2 p-5 mx-16 rounded-3xl surface-border border-round surface-ground flex-auto font-medium"> */}
							<DepositFormApprove_BDCCB flag="BM"/>
						{/* </div>
					</Spin>
				</div>
			</section> */}
...
export default AddEditDipositApproveFormBM_BDCCB
