...
import AddGroupExtendedForm_BDCCB from "../Forms/AddGroupExtendedForm_BDCCB"

function AddGroupFormBM_BDCCB() {
				...
				<div className=" p-5 w-full min-h-screen rounded-3xl">
					...
					>
						<div className="card bg-white border-2 p-5 mx-16 shadow-lg rounded-3xl surface-border border-round surface-ground flex-auto font-medium">
							...
							<AddGroupExtendedForm_BDCCB groupDataArr={loanAppData} />
						</div>
					</Spin>
				</div>
			</section>
...
export default AddGroupFormBM_BDCCB
