...
import LoanBranchSHGDetailsForm_BDCCB from "../Forms/LoanBranchSHGDetailsForm_BDCCB"
import SB_AC_LedgerGroupDetailsForm_BDCCB from "../Forms/SB_AC_LedgerGroupDetailsForm_BDCCB"

function SB_AC_LedgerGroupBM_BDCCB() {
			...
			<section className=" dark:bg-[#001529] flex justify-center align-middle p-5">
				<div className="  p-5 w-full min-h-screen rounded-3xl">
					...
					<div className="w-auto mx-14 my-4">
						<FormHeader text="SB A/C Ledger Group" mode={2} />
					</div>
					<Spin
					...
					>
						<div className="card border-2 p-5 mx-16 bg-white shadow-lg rounded-3xl surface-border border-round surface-ground flex-auto font-medium">
							...
							<SB_AC_LedgerGroupDetailsForm_BDCCB />
						</div>
					</Spin>
				</div>
			</section>
...
export default SB_AC_LedgerGroupBM_BDCCB
