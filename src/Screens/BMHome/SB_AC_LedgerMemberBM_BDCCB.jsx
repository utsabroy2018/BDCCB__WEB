...
import SB_AC_MemberDetailsForm_BDCCB from "../Forms/SB_AC_MemberDetailsForm_BDCCB"

function SB_AC_LedgerMemberBM_BDCCB() {
			...
			<section className=" dark:bg-[#001529] flex justify-center align-middle p-5">
				<div className="  p-5 w-full min-h-screen rounded-3xl">
					...
					<div className="w-auto mx-14 my-4">
						<FormHeader text="SB A/C Member Details Form" mode={2} />
					</div>
					<Spin
...
export default SB_AC_LedgerMemberBM_BDCCB
