...
import RefinaceDisbForm_BDCCB from "../Forms/RefinaceDisbForm_BDCCB"

function EditRefinaceDisbFormPACS_BDCCB() {
				...
				{/* <div className="p-5 w-4/5 min-h-screen rounded-3xl"> */}
					...
					> */}
						{/* <div className="card shadow-lg bg-white border-2 p-5 mx-16 rounded-3xl surface-border border-round surface-ground flex-auto font-medium"> */}
							<RefinaceDisbForm_BDCCB flag="PACS" />
						{/* </div> */}
					{/* </Spin> */}
				{/* </div> */}
			{/* </section> */}
...
export default EditRefinaceDisbFormPACS_BDCCB
