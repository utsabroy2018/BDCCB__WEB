...
import ViewSBACLedgerForm from "../Forms/ViewSBACLedgerForm"

function ViewSBLedgerDetailFormBM() {
			...
			/> */}
				...
				<div className=" p-5 w-4/5 min-h-screen rounded-3xl">
					<div className="w-auto mx-14 my-4">
						<FormHeader text={`View SB A/C Ledger Details`} mode={2} />
					</div>
...
export default ViewSBLedgerDetailFormBM
