...
import ViewSB_AC_LedgerTableBr from "../../Components/ViewSB_AC_LedgerTableBr"

function SearchSB_AC_LedgerBM_BDCCB() {
...
// }
		...
		await axios
			.post(`${url_bdccb}/sbledger/search_sb_shg_grp_view`, creds, {
				headers: {
		...
		<div>
			...
			>
				<main className="px-4 h-auto my-10 mx-32">
					...
					<div className="mt-20">
						...
						<div className="relative mt-10">
							...
							<input
								...
								placeholder="Search Loans by Group Name/Group Code/SB A/C No."
					...
					<ViewSB_AC_LedgerTableBr 
						flag="SOC"
						loanAppData={groups}
						title="Find SB A/C Ledger"
						showSearch={false}
...
export default SearchSB_AC_LedgerBM_BDCCB
