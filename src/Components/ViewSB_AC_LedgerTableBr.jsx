...
function ViewSB_AC_LedgerTableBr({
	loanAppData,
	selectedPacs,
	setSearch,
	title,
			...
			>
				...
				>
					<div className="w-full">
						...
						{/* fghfgh	{JSON.stringify(selectedPacs, 2)}cgfgh */}
							...
							loanAppData?.slice(first, rows + first).map((item, i) => (
								...
								>
									...
									<td className="px-6 py-3 text-slate-700">
										...
										navigate(`/homebm/view-sb-ledger/${item?.group_code}`, {
										state: item,
										})
...
export default ViewSB_AC_LedgerTableBr
