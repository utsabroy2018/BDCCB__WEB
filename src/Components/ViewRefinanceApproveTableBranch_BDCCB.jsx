...
function ViewRefinanceApproveTableBranch_BDCCB({
	loanAppData,
	setSearch,
	title,
	flag,
									...
									<td className="px-6 py-3 text-slate-700">
										<button
												...
												onClick={() => {
													...
													navigate(`/homebm/branch_refinace-approve-list/${item?.group_code}`, {
														state: item,
													})
												}}
											>
...
export default ViewRefinanceApproveTableBranch_BDCCB
